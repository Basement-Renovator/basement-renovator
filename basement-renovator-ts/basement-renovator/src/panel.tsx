...
const FlexBox: React.FunctionComponent<FlexboxProps & Record<string, unknown>> = (props) => {
    const {
        grow: flexGrow,
        shrink: flexShrink,
...
export const Panel: React.FC<PaneProps & Record<string, unknown>> = (props) => (<FlexBox component={Pane} {...props} />)
