...
To apply this transformation, you must install [ImageMagick](https://imagemagick.org/script/download.php) and add it to your system's `PATH` variable (this can be done as part of installation).
